...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs
      .sendForm('service_8lpwhld', 'template_lp9mja2', form.current, {
          publicKey: 'w9mwq49TSuUj_GfAK',
        })
        .then(
          () => {
            console.log('SUCCESS!');
    ...
    return(
        <section className="contact section" id="contact">
            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">+91 9597540729</span>

                            <a href="https://api.whatsapp.com/send?phone=9597540729&text=Hello, more information!" className="contact__button">Write to me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        </div>
                ...
                <div className="contact__content">
                <h3 className="contact__title">Send in your projects</h3>
                ...
                <form ref={form} onSubmit={sendEmail} className="contact__form">
                    ...
                    <div className="contact__form-div">
                        ...
                        <input type="email" name="email" className="contact__form-input" placeholder="Enter your Email ID" />
                    </div>
                    <div className="contact__form-div contact__form-area">
                        <label className="contact__form-tag">Project Details</label>
                        <textarea name="project" cols="30" rows="10" className="contact__form-input" placeholder="Some Details about your project"></textarea>
                    </div>
